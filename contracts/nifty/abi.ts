export default [
    ...
    { type: 'error', name: 'ListingPriceNotProvided', inputs: [] },
    { type: 'error', name: 'NftAlreadyListed', inputs: [] },
    { type: 'error', name: 'NftNotApprovedForMarketplace', inputs: [] },
    { type: 'error', name: 'NftNotListed', inputs: [] },
    { type: 'error', name: 'NoProceedsToWithdraw', inputs: [] },
    { type: 'error', name: 'NotOwnerOfNft', inputs: [] },
    { type: 'error', name: 'WithdrawProceedsFailed', inputs: [] },
    {
        type: 'event',
        anonymous: false,
        name: 'ListingUpdated',
